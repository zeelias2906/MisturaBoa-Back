...
public class PedidoController {
    ...
    // @DeleteMapping("remove-product/{idPedido}/{idProdutoPedido}")
    // @PreAuthorize("hasRole('CLIENTE')")
	// public ResponseEntity<?> deleteProdutoCarrinho(@PathVariable Long idPedido, @PathVariable Long idProdutoPedido ) throws Exception {
	// 	try {
    //         pedidoService.delete(idPedido, idProdutoPedido);
    //         return ResponseEntity.ok().build();
	// 	} catch (Exception e) {
	// 		return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(e);
	// 	}
