    ...
    public Collection<? extends GrantedAuthority> getAuthorities() {
        if (this.roleUsuario == RoleUsuarioEnum.ADMIN) {
			return List.of(new SimpleGrantedAuthority("ROLE_" + RoleUsuarioEnum.ADMIN.name()),
					new SimpleGrantedAuthority("ROLE_" + RoleUsuarioEnum.GARCOM.name()),
					new SimpleGrantedAuthority("ROLE_" + RoleUsuarioEnum.CLIENTE.name()));
		} else if (this.roleUsuario == RoleUsuarioEnum.GARCOM) {
			return List.of(new SimpleGrantedAuthority("ROLE_" + RoleUsuarioEnum.GARCOM.name()),
					new SimpleGrantedAuthority("ROLE_" + RoleUsuarioEnum.CLIENTE.name()));
		} else {
